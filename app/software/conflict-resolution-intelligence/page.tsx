...
import {
  conflictResolutionKPIs,
  conflictResolutionSignals,
  conflictResolutionRisks,
  conflictResolutionActions,
} from "@/lib/software/conflictResolutionEngine";

export default function ConflictResolutionIntelligencePage() {
  return (
    <DashboardShell title="AI Conflict Resolution Intelligence Centre">
        ...
        <div className="mx-auto max-w-7xl space-y-6">
          ...
          <section className="rounded-3xl border border-white/10 bg-white/5 p-6">
            ...
            <h1 className="mt-2 text-4xl font-bold">
              AI Conflict Resolution Intelligence Centre
            </h1>

            <p className="mt-4 max-w-4xl text-slate-300">
              This module analyses interpersonal conflict,
              communication behaviour, cross-functional tension,
              operational disagreements, collaboration pressure,
              and conflict resolution effectiveness.
            </p>
          </section>

          <section className="grid grid-cols-1 gap-4 md:grid-cols-4">
            {conflictResolutionKPIs.map((item) => (
              <div
                key={item.label}
          ...
          <section className="grid grid-cols-1 gap-6 lg:grid-cols-2">
            ...
            <div className="rounded-3xl border border-white/10 bg-slate-900 p-6">
              ...
              <div className="mt-4 space-y-3">
                {conflictResolutionSignals.map((signal) => (
                  <div
                    key={signal}
            ...
            <div className="rounded-3xl border border-red-500/20 bg-red-950/20 p-6">
              ...
              <div className="mt-4 space-y-3">
                {conflictResolutionRisks.map((risk) => (
                  <div
                    key={risk}
          ...
          <section className="rounded-3xl border border-emerald-500/20 bg-emerald-950/20 p-6">
            ...
            <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
              {conflictResolutionActions.map((action) => (
                <div
                  key={action.title}
