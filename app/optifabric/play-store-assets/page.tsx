...
const screenshots: ScreenshotItem[] = [
  ...
  },
  {
    ...
    banglaTitle: "প্যাটার্ন আপলোড",
    route: "/optifabric/cutting-assistant/upload",
    caption: "Upload a pattern photo or PDF without CAD experience.",
    captionBangla:
      "CAD অভিজ্ঞতা ছাড়াই প্যাটার্নের ছবি বা PDF আপলোড করুন।",
  },
  {
    number: "03",
    title: "Fabric Specifications",
    banglaTitle: "ফ্যাব্রিক তথ্য",
    route: "/optifabric/cutting-assistant/fabric-specs",
    caption: "Enter fabric width and engineering information.",
    captionBangla:
      "ফ্যাব্রিকের প্রস্থ ও Engineering তথ্য প্রদান করুন।",
  },
  {
    number: "04",
    title: "Pattern Analysis",
    banglaTitle: "প্যাটার্ন বিশ্লেষণ",
    route: "/optifabric/cutting-assistant/pattern-analysis",
    caption: "AI analyses the traced pattern geometry.",
    captionBangla:
      "AI প্যাটার্নের জ্যামিতি বিশ্লেষণ করে।",
  },
  {
    number: "05",
    title: "Pattern Area",
    banglaTitle: "প্যাটার্ন এলাকা",
    route: "/optifabric/cutting-assistant/pattern-area",
    caption: "Calculate the engineering area accurately.",
    captionBangla:
      "প্যাটার্নের Engineering Area নির্ভুলভাবে গণনা করুন।",
  },
  {
    number: "06",
    title: "Marker Layout",
    banglaTitle: "মার্কার লেআউট",
    route: "/optifabric/cutting-assistant/marker-layout",
    caption: "Visualise intelligent marker placement.",
    captionBangla:
      "AI Marker Layout পর্যবেক্ষণ করুন।",
  },
  {
    number: "07",
    title: "Fabric Consumption",
    banglaTitle: "কাপড় ব্যবহার",
    route: "/optifabric/cutting-assistant/fabric-consumption",
    caption: "Estimate fabric utilisation and savings.",
    captionBangla:
      "কাপড়ের ব্যবহার ও সম্ভাব্য সাশ্রয় নির্ণয় করুন।",
  },
  {
    number: "08",
    title: "Pilot Dashboard",
    banglaTitle: "পাইলট ড্যাশবোর্ড",
    route: "/optifabric/pilot-dashboard",
    caption: "Review the complete engineering workflow.",
    captionBangla:
      "সম্পূর্ণ Engineering Workflow পর্যালোচনা করুন।",
  },
];
