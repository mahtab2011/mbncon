      ...
      <div className="mx-auto max-w-7xl">
        <div className="rounded-3xl bg-gradient-to-r from-slate-900 to-blue-900 p-8 text-white">
          ...
          <p className="mt-5 max-w-3xl text-xl text-slate-200">
            Commercial pilot for garment factories. Every module exists to
            reduce fabric consumption, improve engineering decisions and
            shorten cutting-room preparation time.
          </p>
        </div>
        ...
        <div className="mt-14 rounded-2xl bg-blue-50 p-8">
          ...
          <p className="mt-4 text-lg text-slate-700">
            Every engineering question inside OptiFabric AI has a business
            purpose. The objective is never to collect unnecessary
            information. Each input improves one or more of these:
          </p>
